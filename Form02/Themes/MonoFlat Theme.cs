...
namespace MonoFlat
{
    ...
    public class MonoFlat_ThemeContainer : ContainerControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillRectangle(new SolidBrush(Color.FromArgb(100, 41, 42)), new Rectangle(0, 0, Width, 60));
    ...
    public class MonoFlat_Button : Control
    {
        ...
        public MonoFlat_Button()
        {
            ...
            P3 = new Pen(Color.FromArgb(165, 150, 150)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            Shape.AddArc(0, 0, 14, 14, 180, 90);
            Shape.AddArc(Width - 15, 0, 14, 14, -90, 90);
            Shape.AddArc(Width - 15, Height - 15, 14, 14, 0, 90);
            Shape.AddArc(0, Height - 15, 14, 14, 90, 90);
    ...
    public class MonoFlat_Button2 : Control
    {
        ...
        public MonoFlat_Button2()
        {
            ...
            Size = new Size(146, 41);
            _TextAlignment = StringAlignment.Center;
            P1 = new Pen(Color.FromArgb(100, 100, 100)); // P1 = Border color
            P3 = new Pen(Color.FromArgb(150, 150, 150)); // P3 = Border color when pressed
        }
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(100, 100, 100), Color.FromArgb(100, 100, 100), 90.0F);
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), Color.FromArgb(100, 100, 100), Color.FromArgb(100, 100, 100), 90.0F);
            }
